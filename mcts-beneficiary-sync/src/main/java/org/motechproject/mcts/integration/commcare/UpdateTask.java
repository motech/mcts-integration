...
public class UpdateTask {
    ...
    private String mctsFullnameEn;

    private String mctsHusbandName;

    private String mctsHusbandNameEn;
    ...
    public String getMctsFullnameEn() {
        return mctsFullnameEn;
    }

    @XmlElement(name = "mcts_full_name_en")
    public void setMctsFullnameEn(String mctsFullnameEn) {
        this.mctsFullnameEn = mctsFullnameEn;
    }

    public String getMctsHusbandNameEn() {
        return mctsHusbandNameEn;
    }

    @XmlElement(name = "mcts_husband_name_en")
    public void setMctsHusbandNameEn(String mctsHusbandNameEn) {
        this.mctsHusbandNameEn = mctsHusbandNameEn;
    }
