...
public class MCTSBeneficiarySyncService {
	 ...
	 * @param startDate
	 * @param endDate
	 * @throws Exceptione3.HibernateTransactionManager.doBegin(Hiber
	 */
	 ...
	 * @throws BeneficiaryException 
	 */
	private MctsPregnantMother mapRecordToMctsPregnantMother(Record record) throws BeneficiaryException {
