...
public class MctsRepositoryTest {
	...
	public void findEntityByFieldWithConstarintTest() {
		...
		List<MctsPregnantMother> list = careDataRepository.findEntityByFieldWithConstarint(
				MctsPregnantMother.class, "creationTime", 123, 456);
		verify(dbRepository).findEntitiesByFieldWithConstraint(any(Class.class),
				anyString(), anyObject(), anyObject());
