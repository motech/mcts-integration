...
public class FixtureDataServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        when(
                careDataRepository.findEntityByField(any(Class.class),
                        anyString(), anyInt())).thenReturn(mctsHealthworker);
    }
    ...
    public void shouldGetCaseGroupIdfromAshaId() {
        when(careDataRepository.getCaseGroupIdfromAshaId(15)).thenReturn(null)
                .thenReturn("123");
