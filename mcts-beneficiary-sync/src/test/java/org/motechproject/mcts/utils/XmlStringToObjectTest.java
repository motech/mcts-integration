...
public class XmlStringToObjectTest {
    ...
    public void testToObjectConversion() throws Exception {
        ...
        NewDataSet newDataSet = XmlStringToObjectConverter.stringXmlToObject(
                NewDataSet.class, data);
        assertEquals(newDataSet, getNewDataSetObject());
    }

    private String getNewDataSetXmlString() {
        String data = "<NewDataSet>" + "<Records>" + "<StateID>10</StateID>"
                ...
                + "<SubCentre_Name>Tiri HSC</SubCentre_Name>" + "<Town></Town>"
                + "<Village_ID>0</Village_ID>"
                + "<Village_Name>Direct_Entry </Village_Name"
                + "><ANM_ID>22364</ANM_ID>" + "<ASHA_ID>22753</ASHA_ID>"
                + "<Ward></Ward>"
                ...
                + "<UID_Number></UID_Number>" + "<EID_Number></EID_Number>"
                + "<Birthdate>01-01-1996</Birthdate>" + "<Gender>F</Gender>"
                + "<FatherHusbandName>Pramchandr Yadav</FatherHusbandName>"
                + "<BeneficiaryAddress>Tiri</BeneficiaryAddress>"
                + "<PinCode></PinCode>" + "<Category>Others</Category>"
                + "<Economic_Status>Not Known</Economic_Status>"
                + "<Mobile_no>9572701531</Mobile_no>" + "<Email></Email>"
                + "<LMP_Date>20-04-2013</LMP_Date>" + "</Records>"
                + "</NewDataSet>";
        return data;
    }

    private NewDataSet getNewDataSetObject() {
        Record record = new Record("10", "Bihar", "12", "Saharsa", "180",
                "Saor Bazar", "0163", "Saur Bazar", "175", "Saur Bazar",
                "6357", "Tiri HSC", null, "0", "Direct_Entry", "22364",
                "22753", null, "MOTHER", "101216300411300078", "Rubi Devi",
                null, null, "01-01-1996", "F", "Pramchandr Yadav", "Tiri",
                null, "ST", "Not Known", "9572701531", null, "20-04-2013");
