...
public class EncryptionTest {
    ...
    @Test
    public void shouldTestDecryprtion() throws InvalidKeyException,
        ...
        System.out.println("Decrypted password along with timestamp: "
                + decrypted);
        assertEquals(shouldEncryptWithTimeInSeconds(password).length(),
                decrypted.length());
